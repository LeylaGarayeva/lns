...
<ul class="shortcut-buttons-set">
	...
	<li>
		<a class="shortcut-button" href="?menu=olkeler&mod=add">
		<span>
...
<div class="content-box">
	...
	<div class="content-box-content">
		...
		<?PHP
			@$mod = $_GET['mod'];
			if($mod == 'add'){ include 'olkeler/add.php';}
			elseif($mod == 'edit'){ include 'olkeler/edit.php';}
			elseif($mod == 'delete'){ include 'olkeler/delete.php';}
			elseif($mod == 'editphotos'){ include 'olkeler/edit_photos.php';}
			elseif($mod == 'addphotos'){ include 'olkeler/add_photos.php';}
			else{ include 'olkeler/list.php';}
		?>
	</div>
</div>