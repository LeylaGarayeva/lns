...
<ul class="shortcut-buttons-set">
	...
	<li>
		<a class="shortcut-button" href="?menu=kateqoriyalar&mod=add">
		<span>
...
<div class="content-box">
	...
	<div class="content-box-content">
		...
		<?PHP
			@$mod = $_GET['mod'];
			if($mod == 'add'){ include 'kateqoriyalar/add.php';}
			elseif($mod == 'edit'){ include 'kateqoriyalar/edit.php';}
			elseif($mod == 'delete'){ include 'kateqoriyalar/delete.php';}
			elseif($mod == 'editphotos'){ include 'kateqoriyalar/edit_photos.php';}
			elseif($mod == 'addphotos'){ include 'kateqoriyalar/add_photos.php';}
			else{ include 'kateqoriyalar/list.php';}
		?>
	</div>
</div>