...
<ul class="shortcut-buttons-set">
	...
	<li>
		<a class="shortcut-button" href="?menu=elanlar&mod=add">
		<span>
...
<div class="content-box">
	...
	<div class="content-box-content">
		...
		<?PHP
			@$mod = $_GET['mod'];
			if($mod == 'add'){ include 'elanlar/add.php';}
			elseif($mod == 'edit'){ include 'elanlar/edit.php';}
			elseif($mod == 'delete'){ include 'elanlar/delete.php';}
			elseif($mod == 'editphotos'){ include 'elanlar/edit_photos.php';}
			elseif($mod == 'addphotos'){ include 'elanlar/add_photos.php';}
			else{ include 'elanlar/list.php';}
		?>
	</div>
</div>