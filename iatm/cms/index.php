	...
	?>
		...
		<html xmlns="http://www.w3.org/1999/xhtml"> 
			<head>
				...
				<link rel="shortcut icon" href="images/loqo2.png">
				<!--  CSS  -->
				...
				<div id="body-wrapper">
					<div id="sidebar">
						<div id="sidebar-wrapper"> <!-- Sidebar logo ve menu -->
							<!-- Loqo -->
							<a href="<?PHP echo $sayt_url; ?>"><img id="logo" src="images/loqo2.png" alt="WebCity logo" /></a>
							<!-- Linkler -->
							<div id="profile-links">
								<font color="silver"><a href="http://webcity.az/" title="WebCity" target="_blank">WebCity</a> | <a href="<?PHP echo $sayt_url_index;?>" title="Sayta bax"  target="_blank"><?php echo $dil['menu1'][$lng]; ?></a> | <a href="?exit=cix" title="Paneldən çıx"><?php echo $dil['menu2'][$lng]; ?></a>
							</div>
		<!--------------------------------------------- Accordion Menu --------------------------------------->
		...
		<!------------------------------------------- Idare paneli ---------------------------------------->
						...
						<div id="footer">
							<small>
									&#169; Copyright 2016 <a href="http://webcity.az/" style="font-size: 13px;font-weight: bold;color: #8A5EA6;" target="_blank">WebCity</a>
							</small>
						</div><!-- footer -->		
		<!------------------------------------------------------------------------------------------------->
