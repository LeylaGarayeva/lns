...
$sayt_url_index = 'http://iatm.az/';
$sayt_url = 'http://iatm.az/cms/';
$bazahost = "localhost";
$bazaname = "iatmaz_orxan";
$bazauser = "iatmaz_orxan";
$bazapass = "iatmaz_orxan";//mysql_connect($bazahost, $bazauser, $bazapass) or die ('Mysqele qoshulmada sef var');
