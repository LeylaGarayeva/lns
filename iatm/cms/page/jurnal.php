...
<ul class="shortcut-buttons-set">
	...
	<li>
		...
		<a class="shortcut-button" href="?menu=jurnal&mod=add">
...
<div class="content-box">
	...
	<div class="content-box-content">
		...
		<?PHP
			...
			if($mod == 'add'){ include 'jurnal/add.php';}

			elseif($mod == 'edit'){ include 'jurnal/edit.php';}

			elseif($mod == 'delete'){ include 'jurnal/delete.php';}

			else{ include 'jurnal/list.php';}
