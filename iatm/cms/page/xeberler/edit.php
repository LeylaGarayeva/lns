...
$tip=0;
if(!empty($avatar)){
$product22=MYSQLI_QUERY($connection,"SELECT * from `xeberler` where l_id='1' and u_id='".$idx."'");		$product=MYSQLI_FETCH_ARRAY($product22);		if(file_exists('../products/'.$product['photo'].'')){		unlink('../products/'.$product['photo'].'');		}		else{}
