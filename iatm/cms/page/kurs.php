...
<ul class="shortcut-buttons-set">
	...
	<li>
		...
		<a class="shortcut-button" href="?menu=kurs&mod=add">
...
<div class="content-box">
	...
	<div class="content-box-content">
		...
		<?PHP
			...
			if($mod == 'add'){ include 'kurs/add.php';}

			elseif($mod == 'edit'){ include 'kurs/edit.php';}

			elseif($mod == 'delete'){ include 'kurs/delete.php';}

			else{ include 'kurs/list.php';}
