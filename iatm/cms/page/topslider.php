...
<ul class="shortcut-buttons-set">
	...
	<li>
		...
		<a class="shortcut-button" href="?menu=topslider&mod=add">
...
<div class="content-box">
	...
	<div class="content-box-content">
		...
		<?PHP
			...
			if($mod == 'add'){ include 'topslider/add.php';}

			elseif($mod == 'edit'){ include 'topslider/edit.php';}

			elseif($mod == 'delete'){ include 'topslider/delete.php';}

			else{ include 'topslider/list.php';}
