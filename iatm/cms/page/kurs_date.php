...
<?PHP if(@$mod != 'add' and @$mod != 'edit' and isset($cat_id)){ ?>
<ul class="shortcut-buttons-set">
	...
	<li>
		...
		<a class="shortcut-button" href="?menu=kurs_date&cat_id=<?PHP echo $cat_id; ?>&mod=add">

		<span>

			<img src="images/silder.jpeg" width="45px" height="45px" alt="Yeni slider" /><br />

			<?php echo $dil['Yeni_slider'][$lng]; ?>
...
<div class="content-box">
	...
	<div class="content-box-header">
		...
		<h3 style="width:87%;"><?php echo $dil['Yeni_slider'][$lng]; ?></h3>
	...
	<div class="content-box-content">
		...
		<?PHP
			...
			if($mod == 'add'){ include 'kurs_date/add.php';}

			elseif($mod == 'edit'){ include 'kurs_date/edit.php';}

			elseif($mod == 'delete'){ include 'kurs_date/delete.php';}

			else{ include 'kurs_date/list.php';}
